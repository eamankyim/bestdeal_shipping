...
# Create Host-Level Nginx Router

set -e

echo "=========================================="
echo "CREATING HOST-LEVEL NGINX ROUTER"
echo "=========================================="
echo ""
...
echo ""
echo "Next steps:"
echo "1. Update service nginx to internal ports"
echo "2. Create shared network"
echo "3. Connect all containers to network"
echo "4. Start host nginx"
echo ""
